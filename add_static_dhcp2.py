...
print(f"\nPool list: {list_result[:1000]}")

# Find pool ID from response
pool_0i_match = re.search(r"rtm_cfg_dhcpv4_svr_pool_0i[^>]*>([^<]+)<", list_result)
pool_0i = pool_0i_match.group(1) if pool_0i_match else ""
print(f"pool_0i: {pool_0i}")
...
if pool_0i:
    ...
    pool_id = "0"
    print("No pool found, trying with 0")
